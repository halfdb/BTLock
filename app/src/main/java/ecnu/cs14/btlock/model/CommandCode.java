...
//        public static final byte UID_53 = getUidOf(5, 3);
    ...
    public static final class account {
        public static final byte CMD_ADD = 0x08;
        public static final byte CMD_ADD_ACK = rawBinary(0x88);
        
        public static final byte CMD_DEL_PREFIX = 0x60;
        public static byte getCmdDel(int u, int uToDel) {
            return (byte) (CMD_DEL_PREFIX | (u << 2) | ((uToDel + 4 - u) % 5) );
        }
        public static final byte CMD_DEL_ACK = rawBinary(0xE0);

        public static final byte CMD_NEW_PWD_PREFIX = 0x40;
        public static byte getCmdNewPwd(byte uid) {
